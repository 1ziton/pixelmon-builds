...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@pixelmon/acl', ['exports', '@angular/core', 'rxjs', '@pixelmon/util', 'rxjs/operators', '@angular/router', '@angular/common'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.acl = {}), global.ng.core, global.rxjs, global.pixelmon.util, global.rxjs.operators, global.ng.router, global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var PixelmonACLConfig = /** @class */ (function () {
        ...
        /** @nocollapse */ PixelmonACLConfig.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function PixelmonACLConfig_Factory() { return new PixelmonACLConfig(); }, token: PixelmonACLConfig, providedIn: "root" });
    ...
    var ACLGuard = /** @class */ (function () {
        ...
        /** @nocollapse */ ACLGuard.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ACLGuard_Factory() { return new ACLGuard(core.ɵɵinject(ACLService), core.ɵɵinject(router.Router), core.ɵɵinject(PixelmonACLConfig)); }, token: ACLGuard, providedIn: "root" });
        return ACLGuard;
    }());
    if (false) {
        /**
    ...
    exports.PixelmonACLConfig = PixelmonACLConfig;
    exports.PixelmonACLModule = PixelmonACLModule;
