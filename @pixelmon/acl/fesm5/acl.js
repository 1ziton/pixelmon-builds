...
var PixelmonACLConfig = /** @class */ (function () {
    ...
    /** @nocollapse */ PixelmonACLConfig.ngInjectableDef = ɵɵdefineInjectable({ factory: function PixelmonACLConfig_Factory() { return new PixelmonACLConfig(); }, token: PixelmonACLConfig, providedIn: "root" });
...
var ACLGuard = /** @class */ (function () {
    ...
    /** @nocollapse */ ACLGuard.ngInjectableDef = ɵɵdefineInjectable({ factory: function ACLGuard_Factory() { return new ACLGuard(ɵɵinject(ACLService), ɵɵinject(Router), ɵɵinject(PixelmonACLConfig)); }, token: ACLGuard, providedIn: "root" });
    return ACLGuard;
}());
if (false) {
    /**
...
export { ACLDirective, ACLGuard, ACLIfDirective, ACLService, PixelmonACLConfig, PixelmonACLModule };
