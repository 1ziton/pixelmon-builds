...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@pixelmon/cache', ['exports', '@angular/common/http', '@angular/core', 'date-fns/add_seconds', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.cache = {}), global.ng.common.http, global.ng.core, global.addSeconds, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var PixelmonCacheConfig = /** @class */ (function () {
        ...
        /** @nocollapse */ PixelmonCacheConfig.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function PixelmonCacheConfig_Factory() { return new PixelmonCacheConfig(); }, token: PixelmonCacheConfig, providedIn: "root" });
    ...
    var CacheService = /** @class */ (function () {
        function CacheService(_, store, http) {
            ...
            this.freqTick = 3000;
            this.cog = {};
            Object.assign(this.cog, __assign({}, new PixelmonCacheConfig(), _));
            this.loadMeta();
        ...
        /** @nocollapse */ CacheService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function CacheService_Factory() { return new CacheService(core.ɵɵinject(PixelmonCacheConfig), core.ɵɵinject(DC_STORE_STORAGE_TOKEN), core.ɵɵinject(http.HttpClient)); }, token: CacheService, providedIn: "root" });
        return CacheService;
    }());
    if (false) {
        /**
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var PixelmonCacheModule = /** @class */ (function () {
        function PixelmonCacheModule() {
        }
        PixelmonCacheModule.decorators = [
    ...
    exports.PixelmonCacheConfig = PixelmonCacheConfig;
    exports.PixelmonCacheModule = PixelmonCacheModule;
