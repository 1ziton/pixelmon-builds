...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@pixelmon/theme'), require('@pixelmon/util'), require('@angular/common'), require('ng-zorro-antd/tooltip')) :
    typeof define === 'function' && define.amd ? define('@pixelmon/chart/mini-progress', ['exports', '@angular/core', '@pixelmon/theme', '@pixelmon/util', '@angular/common', 'ng-zorro-antd/tooltip'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.chart = global.pixelmon.chart || {}, global.pixelmon.chart['mini-progress'] = {}), global.ng.core, global.pixelmon.theme, global.pixelmon.util, global.ng.common, global['ng-zorro-antd/tooltip']));
    ...
    var G2MiniProgressModule = /** @class */ (function () {
        ...
        G2MiniProgressModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, util.PixelmonUtilModule, theme.PixelmonLocaleModule, tooltip.NzToolTipModule],
