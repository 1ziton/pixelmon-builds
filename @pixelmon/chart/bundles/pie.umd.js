...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@pixelmon/util'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('ng-zorro-antd/divider')) :
    typeof define === 'function' && define.amd ? define('@pixelmon/chart/pie', ['exports', '@angular/core', '@pixelmon/util', 'rxjs', 'rxjs/operators', '@angular/common', 'ng-zorro-antd/divider'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.chart = global.pixelmon.chart || {}, global.pixelmon.chart.pie = {}), global.ng.core, global.pixelmon.util, global.rxjs, global.rxjs.operators, global.ng.common, global['ng-zorro-antd/divider']));
    ...
    var G2PieModule = /** @class */ (function () {
        ...
        G2PieModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, util.PixelmonUtilModule, divider.NzDividerModule],
