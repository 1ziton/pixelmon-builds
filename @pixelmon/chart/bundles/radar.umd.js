...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@pixelmon/util'), require('@angular/common'), require('ng-zorro-antd/grid')) :
    typeof define === 'function' && define.amd ? define('@pixelmon/chart/radar', ['exports', '@angular/core', '@pixelmon/util', '@angular/common', 'ng-zorro-antd/grid'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.chart = global.pixelmon.chart || {}, global.pixelmon.chart.radar = {}), global.ng.core, global.pixelmon.util, global.ng.common, global['ng-zorro-antd/grid']));
    ...
    var G2RadarModule = /** @class */ (function () {
        ...
        G2RadarModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, util.PixelmonUtilModule, grid.NzGridModule],
