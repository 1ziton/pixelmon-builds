...
({ command, text, icon, key }) => {
    ...
    /** @type {?} */
    const spanNode = React__default.createElement('span', { key: 'span' }, spanText);
    /** @type {?} */
    const divNode = React__default.createElement('div', { className: 'menu-item' }, [
...
() => {
    /** @type {?} */
    const NodeMenuEl = createElement(NodeMenu, { key: 'nodemenu' }, [menuItemGenerate({ command: 'copy' }), menuItemGenerate({ command: 'delete' })]);
    /** @type {?} */
    const EdgeMenuEl = createElement(EdgeMenu, { key: 'edgemenu' }, menuItemGenerate({ command: 'delete' }));
    /** @type {?} */
    const GroupMenuEl = createElement(GroupMenu, { key: 'groupmenu' }, [
        menuItemGenerate({ command: 'copy' }),
        menuItemGenerate({ command: 'delete' }),
        menuItemGenerate({ command: 'unGroup', text: 'Ungroup', icon: 'ungroup' }),
    ]);
    /** @type {?} */
    const MultiMenuEl = createElement(MultiMenu, { key: 'multimenu' }, [
        menuItemGenerate({ command: 'copy' }),
    ...
    /** @type {?} */
    const CanvasMenuEl = createElement(CanvasMenu, { key: 'canvasmenu' }, [
...
class DetailForm extends React__default.Component {
    constructor() {
        super(...arguments);
        this.handleSubmit = (/**
         * @param {?} e
         ...
         */
        () => {
            return React__default.createElement(Select, { onChange: this.handleSubmit, key: 'edgeshapselect' }, [
        ...
        () => {
            ...
            return React__default.createElement((/** @type {?} */ (Item)), Object.assign({ label: 'Label' }, inlineFormItemLayout, { key: 'nodedetailitem' }), form.getFieldDecorator('label', {
                initialValue: label,
                key: 'nodedetaillabel',
            })(React__default.createElement(Input, { onBlur: this.handleSubmit, key: 'nodedetaillabel-input' })));
            // return (
        ...
        () => {
            ...
            return React__default.createElement((/** @type {?} */ (Item)), Object.assign({ label: 'Shape' }, inlineFormItemLayout, { key: 'shapitem' }), form.getFieldDecorator('shape', {
                initialValue: shape,
        ...
        () => {
            ...
            return React__default.createElement((/** @type {?} */ (Fragment)), { key: 'fagment' }, [this.renderNodeDetail(), this.shapeItem()]);
            // return (
            //   <Fragment>
            //   <Item label= "Label" {...inlineFormItemLayout }>
            //     {
        ...
        () => {
            ...
            return React__default.createElement((/** @type {?} */ (Item)), Object.assign({ label: 'Label' }, inlineFormItemLayout), [
                form.getFieldDecorator('label', {
                    initialValue: label,
                    key: 'groupdetailitem',
                }),
                React__default.createElement(Input, { onBlur: this.handleSubmit, key: 'input' }),
            ]);
            // return (
            //   <Item label= "Label" {...inlineFormItemLayout }>
            //     {
...
(props) => {
    ...
    return React__default.createElement(GGEditor, { className: 'editor' }, [
        ...
        React__default.createElement(Row, { type: 'flex', className: 'editorBd', key: 'editorBd' }, [
            ...
            React__default.createElement(Col, { span: 16, className: 'editorContent', key: 'editorContent' }, React__default.createElement(Flow, { data, style: { width: '100%', height: '100%' } })),
