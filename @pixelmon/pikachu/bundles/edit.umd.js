...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@pixelmon/util'), require('@angular/animations'), require('@angular/forms'), require('@pixelmon/theme'), require('@angular/common'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/tooltip')) :
    typeof define === 'function' && define.amd ? define('@pixelmon/pikachu/edit', ['exports', '@angular/core', '@pixelmon/util', '@angular/animations', '@angular/forms', '@pixelmon/theme', '@angular/common', 'ng-zorro-antd/icon', 'ng-zorro-antd/tooltip'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.pikachu = global.pixelmon.pikachu || {}, global.pixelmon.pikachu.edit = {}), global.ng.core, global.pixelmon.util, global.ng.animations, global.ng.forms, global.pixelmon.theme, global.ng.common, global['ng-zorro-antd/icon'], global['ng-zorro-antd/tooltip']));
    ...
    var SEModule = /** @class */ (function () {
        ...
        SEModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, util.PixelmonUtilModule, tooltip.NzToolTipModule, icon.NzIconModule],
