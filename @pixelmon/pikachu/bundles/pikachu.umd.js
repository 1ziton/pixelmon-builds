...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixelmon/pikachu/lodop'), require('@pixelmon/pikachu/reuse-tab'), require('@pixelmon/pikachu/notice-icon'), require('@pixelmon/pikachu/sidebar-nav'), require('@pixelmon/pikachu/view'), require('@pixelmon/pikachu/page-header'), require('@pixelmon/pikachu/advanced-table'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@pixelmon/pikachu/viewer'), require('ng-zorro-antd'), require('rxjs'), require('rxjs/operators'), require('@pixelmon/theme'), require('ng-zorro-antd/tooltip'), require('@pixelmon/util'), require('ng-zorro-antd/badge'), require('ng-zorro-antd/dropdown'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/list'), require('ng-zorro-antd/spin'), require('ng-zorro-antd/tabs'), require('ng-zorro-antd/tag'), require('@angular/router'), require('ng-zorro-antd/affix'), require('ng-zorro-antd/breadcrumb'), require('ng-zorro-antd/skeleton'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('ng-zorro-antd/menu'), require('@angular/cdk/observers')) :
    typeof define === 'function' && define.amd ? define('@pixelmon/pikachu', ['exports', '@pixelmon/pikachu/lodop', '@pixelmon/pikachu/reuse-tab', '@pixelmon/pikachu/notice-icon', '@pixelmon/pikachu/sidebar-nav', '@pixelmon/pikachu/view', '@pixelmon/pikachu/page-header', '@pixelmon/pikachu/advanced-table', '@angular/core', '@angular/common', '@angular/forms', '@pixelmon/pikachu/viewer', 'ng-zorro-antd', 'rxjs', 'rxjs/operators', '@pixelmon/theme', 'ng-zorro-antd/tooltip', '@pixelmon/util', 'ng-zorro-antd/badge', 'ng-zorro-antd/dropdown', 'ng-zorro-antd/icon', 'ng-zorro-antd/list', 'ng-zorro-antd/spin', 'ng-zorro-antd/tabs', 'ng-zorro-antd/tag', '@angular/router', 'ng-zorro-antd/affix', 'ng-zorro-antd/breadcrumb', 'ng-zorro-antd/skeleton', '@angular/cdk/overlay', '@angular/cdk/portal', 'ng-zorro-antd/menu', '@angular/cdk/observers'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.pikachu = {}), global.pixelmon.pikachu.lodop, global.pixelmon.pikachu['reuse-tab'], global.pixelmon.pikachu['notice-icon'], global.pixelmon.pikachu['sidebar-nav'], global.pixelmon.pikachu.view, global.pixelmon.pikachu['page-header'], global.pixelmon.pikachu['advanced-table'], global.ng.core, global.ng.common, global.ng.forms, global.pixelmon.pikachu.viewer, global.ngZorroAntd, global.rxjs, global.rxjs.operators, global.theme, global.tooltip, global.util, global.badge, global.dropdown, global.icon, global.list, global.spin, global.tabs, global.tag, global.ng.router, global.affix, global.breadcrumb, global.skeleton, global.ng.cdk.overlay, global.ng.cdk.portal, global.menu, global.ng.cdk.observers));
}(this, function (exports, lodop, reuseTab, noticeIcon, sidebarNav, view, pageHeader, advancedTable, core, common, forms, viewer, ngZorroAntd, rxjs, operators, theme, tooltip, util, badge, dropdown, icon, list, spin, tabs, tag, router, affix, breadcrumb, skeleton, overlay, portal, menu, observers) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.ɵc = AdvancedCellComponent;
    exports.ɵd = AdvancedFilterComponent;
    exports.ɵe = QueryDisplayModule;
    exports.ɵf = QueryDisplayComponent;
    exports.ɵg = SmartTextModule;
    exports.ɵh = SmartTextComponent;
    exports.ɵi = ReuseTabModule;
    exports.ɵj = NoticeIconModule;
    exports.ɵk = SidebarNavModule;
    exports.ɵl = SVModule;
    exports.ɵm = PageHeaderModule;
