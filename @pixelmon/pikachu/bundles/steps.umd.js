...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@pixelmon/util')) :
    typeof define === 'function' && define.amd ? define('@pixelmon/pikachu/steps', ['exports', '@angular/core', '@angular/common', '@pixelmon/util'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.pikachu = global.pixelmon.pikachu || {}, global.pixelmon.pikachu.steps = {}), global.ng.core, global.ng.common, global.pixelmon.util));
    ...
    var StepsComponent = /** @class */ (function () {
        ...
        function (contentSelector, steps) {
            ...
            /** @type {?} */
            var containerWidth = util.DomHandler.getOuterWidth(container);
            /** @type {?} */
            var containerOffsetLeft = util.DomHandler.getOffset(container).left;
            /** @type {?} */
            ...
            for (var index = 0; index < contents.length; index++) {
                ...
                /** @type {?} */
                var contentWidth = util.DomHandler.getOuterWidth(content);
                /** @type {?} */
                var contentOffsetLeft = util.DomHandler.getOffset(content).left;
                // 原则是能尽量左对齐
        ...
        StepsComponent.propDecorators = {
            activeBackground: [{ type: core.Input }],
            activeWidth: [{ type: core.Input }],
            inactiveBackground: [{ type: core.Input }],
            backgroundImage: [{ type: core.Input }],
            activePointTemplate: [{ type: core.Input }],
            activePointColor: [{ type: core.Input }],
            activeContentColor: [{ type: core.Input }],
            activeContentBackground: [{ type: core.Input }],
            activeContentAlign: [{ type: core.Input }],
            activeStep: [{ type: core.Input }],
            keyPointTemplate: [{ type: core.Input }],
            keyPointColor: [{ type: core.Input }],
            keyContentColor: [{ type: core.Input }],
            keyContentBackground: [{ type: core.Input }],
            keySteps: [{ type: core.Input }],
            extraPointTemplate: [{ type: core.Input }],
            extraPointColor: [{ type: core.Input }],
            extraContentColor: [{ type: core.Input }],
            extraContentBackground: [{ type: core.Input }],
            extraContentAlign: [{ type: core.Input }],
            extraSteps: [{ type: core.Input }]
        };
...
//# sourceMappingURL=steps.umd.js.map
