...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@pixelmon/util'), require('@angular/common'), require('@pixelmon/theme'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('@pixelmon/pikachu/tag-select', ['exports', '@angular/core', '@pixelmon/util', '@angular/common', '@pixelmon/theme', 'ng-zorro-antd/icon'], factory) :
    (global = global || self, factory((global.pixelmon = global.pixelmon || {}, global.pixelmon.pikachu = global.pixelmon.pikachu || {}, global.pixelmon.pikachu['tag-select'] = {}), global.ng.core, global.pixelmon.util, global.ng.common, global.pixelmon.theme, global['ng-zorro-antd/icon']));
}(this, function (exports, core, util, common, theme, icon) { 'use strict';
    ...
    var TagSelectModule = /** @class */ (function () {
        ...
        TagSelectModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, icon.NzIconModule, theme.PixelmonLocaleModule, util.PixelmonUtilModule],
