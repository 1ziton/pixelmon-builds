 ...
 */
/** @type {?} */
const COMPONENTS$1 = [NoticeIconComponent];
...
NoticeIconModule.decorators = [
    { type: NgModule, args: [{
                ...
                declarations: [...COMPONENTS$1, NoticeIconTabComponent],
 ...
 */
/** @type {?} */
const COMPONENTS$2 = [PageHeaderComponent];
 ...
 */
/** @type {?} */
const COMPONENTS$3 = [ReuseTabComponent];
/** @type {?} */
...
ReuseTabModule.decorators = [
    { type: NgModule, args: [{
                ...
                declarations: [...COMPONENTS$3, ...NOEXPORTS],
 ...
 */
/** @type {?} */
const COMPONENTS$4 = [SVContainerComponent, SVComponent, SVTitleComponent];
class SVModule {
}
SVModule.decorators = [
    { type: NgModule, args: [{
