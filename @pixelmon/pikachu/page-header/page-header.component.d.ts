...
import { PixelmonI18NService, MenuService, SettingsService, TitleService } from '@pixelmon/theme';
...
export declare class PageHeaderComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
    ...
    constructor(cog: PageHeaderConfig, settings: SettingsService, renderer: Renderer2, router: Router, menuSrv: MenuService, i18nSrv: PixelmonI18NService, titleSrv: TitleService, reuseSrv: ReuseTabService, cdr: ChangeDetectorRef);
    refresh(): void;
