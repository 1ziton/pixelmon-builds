...
/** @type {?} */
const PIXELMON_I18N_TOKEN = new InjectionToken('pixelmonTranslatorToken', {
    providedIn: 'root',
 ...
 */
/** @type {?} */
const DELON_LOCALE = new InjectionToken('pixelmon-locale');
 ...
 */
/** @type {?} */
const VERSION = new Version('0.1.10-4a79c0e');
